...
- (void)createViews
{
   ...
   if (@available(iOS 11.0, *)) {
    ...
    if (_browserOptions.addresslabelcolor != nil) { // Set addressLabel color if user sets it in options
      self.addressLabel.backgroundColor = [self colorFromHexString:_browserOptions.addresslabelcolor];
    } else {
